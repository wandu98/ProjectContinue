                                    ...
                                    <ul class="pagination">
                                        <li class="page-item">
                                            <c:if test="${startPage>0}">
                                                <a class="page-link" onclick="prePage(${startPage})" href="/seller/search?pageNum=${startPage}}" aria-label="Previous">
                                        ...
                                        <c:forEach var="i" begin="${startPage+1}" end="${endPage-1}">
                                            <c:choose>
                                                ...
                                                <c:when test="${pageNum!=i}"><li class="page-item"><a class="page-link" onclick="next(${i})">${i}</a></li></c:when>
                                            </c:choose>
                                        </c:forEach>
                                        <c:if test="${endpage<=pageCount}">
                                            <li class="page-item">
                                                <a class="page-link" onclick="nextPage(${startPage+11})" aria-label="Next">
