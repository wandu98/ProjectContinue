                                            ...
                                            <table id="rcttable">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        ...
                                                        <tr>
                                                            <td class="shoping__cart__item" onclick="recruitDetail(${row.rcrbrd_num})">
                                                                <img class="gm_img" src="/images/thumb/${row.gm_code}/thumb.jpg">
                                                                <h5 style="font-weight: 700">${row.rcrbrd_subject}</h5>
                                                            </td>
                                                            <td class="shoping__cart__price gm_name" onclick="recruitDetail(${row.rcrbrd_num})">
                                                                ${row.gm_name}
                                                            </td>
...
<script>
    ...
    function recruitDetail(rcrbrd_num) {
        location.replace("/recruit/detail/"+rcrbrd_num);
    }
