...
-- 모집게시판
INSERT INTO tb_rcrboard(mem_id, rcrbrd_subject, rcrbrd_content, rcrbrd_pw, rcrbrd_views, rcrbrd_regdate, rcrbrd_ip, gm_code, rcrbrd_status)
VALUES ('gjdjj888', '잠실 핵주먹을 찾습니다', '핵주먹 뭐하냐', '1234', 2, '20221121', '192.195.14.23', 'DT0001', '마감')
     ,('oejdf9090', '추노', '도망쳐', '1234', 3, '20221121', '192.195.14.97', 'AC0001', '진행중')
     ,('fjhdmj555', '아이언맨', '토니 김홍승', '1234', 4, '20221121', '192.195.14.77', 'PT0001', '마감')
     ,('fjhdmj555', '아이언맨2', '스타크 김홍승', '1234', 21, '20221121', '192.195.14.36', 'DT0002', '진행중');


-- 모집정보
INSERT INTO tb_recruit(mem_id, rcrbrd_num)
VALUES ('oejdf9090', 1)
     ,('gjdjj888', 2)
     ,('fjhdmj555', 3)
     ,('fjhdmj555', 4)
